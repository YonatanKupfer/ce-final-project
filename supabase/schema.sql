...
CREATE TABLE projects (
  ...
  track TEXT NOT NULL CHECK (track IN ('crypto', 'hardware', 'networks', 'algorithms', 'software', 'ai', 'signal')),
  recommended_track TEXT CHECK (recommended_track IN ('crypto', 'hardware', 'networks', 'algorithms', 'software', 'ai', 'signal')),
