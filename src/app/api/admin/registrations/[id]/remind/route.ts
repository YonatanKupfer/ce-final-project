...
export async function POST(
    ...
    `;
      ...
      `;
        ...
        <p style="color: #888; font-size: 13px; margin-top: 24px;">לחיצה על אחד הכפתורים תעביר אותך לעמוד אישור לפני קבלת ההחלטה הסופית. מייל זה נשלח הן למנחה והן לאחראי.ת האקדמי.ת — מי מכם שיחליט/י ראשון/ה, ההחלטה תיקבע בהתאם.</p>
      `),
        });
